...
class AdminCategoriesController extends \BaseController {
	 ...
	 * 
	 */
	 function __construct(UserRepositoryInterface $user, CategoryRepositoryInterface $category, adminNewCategoryForm $adminNewCategoryForm, BrandRepositoryInterface $brand)
	 {
		$this->user					= $user;
	...
	public function index()
	{
		...
		return View::make('admin.categories.index')->withCategories($categories);
	...
	public function edit($id)
	{
		...
		return View::make('admin.categories.edit')->withCategory($category);
	}
	...
	public function postAdminCategoriesActions()
	{
