...
class AdminEventsController extends \BaseController {
    ...
    public function index()
    {
        ...
        $events = Post::withTrashed()->where('type',$type)->orderBy('created_at','desc')->get();

        return View::make('admin.brands.events.index')->withEvents($events);
    }
    ...
    public function create()
    {
        ...
        return View::make('admin.brands.events.create')->withBrands($brands);
    }
    ...
    public function store()
    {
        if( Input::has('event') )
        {
            $input = Input::only('brand_id','size','name','description','short_description','isfree','time_from','time_to','registration_url','state','city','contact_details');
   ...
   if(Input::hasFile('event_image'))
{
        ...
        //upload the event image and save the to database
            ...
            return Redirect::route('admin_events')->withFlashMessage('Event has been successfully created!');
        }
    }
    ...
    public function edit($id)
    {
        $event 		= $this->post->find($id);
         $brands = Brand::orderBy('id')->lists('name', 'id');
           $cities= City::where('state_id','=',$event->state)->lists('name', 'id');
        return View::make('admin.brands.events.edit')->withCities($cities)->withEvent($event)->withBrands($brands);
    }
    /**
    ...
    public function update($id)
    {
        ...
        return Redirect::route('admin_events')->withFlashMessage('Event have been successfully updated!');
    }
    ...
    public function postAdminEventsActions()
    {
