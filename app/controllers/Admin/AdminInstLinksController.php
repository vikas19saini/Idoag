...
class AdminInstLinksController extends \BaseController {
	...
	public function index()
    {
		...
		return View::make('admin.institutions.links.index')->withLinks($links);
	}
	...
	public function create()
	{
		...
		return View::make('admin.institutions.links.create')->withInstitutions($institutions);
	}
	...
	public function store()
	{
        if(Input::has('instext'))
        {
            ...
            return Redirect::route('admin_inst_links')->withFlashMessage('Link have been successfully created!');
        }
	}
	...
	public function edit($id)
	{
		...
		return View::make('admin.institutions.links.edit')->withlink($link);
	}
	...
	public function update($id)
	{
		...
		return Redirect::route('admin_inst_links')->withFlashMessage('Link have been successfully updated!');
	}
	...
	public function postAdminInstLinksActions()
	{
