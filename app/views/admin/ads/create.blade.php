...
@section('title', 'Idoag.com | Add Ad')
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        {{ Form::open(['route' => 'admin.ads.store', 'class' => 'form-horizontal','id' => 'add-new-page-form', 'files' => 'true']) }}
                                        ...
                                        @include('admin.partials.ad_form')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-offset-3 col-sm-8">
                                                    ...
                                                    {{ Form::submit('Add Ad', ['class' => 'btn btn-lg btn-info btn-block']) }}
