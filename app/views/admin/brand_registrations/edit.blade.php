        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="{{ URL::route('admin_brand_registrations') }}" class="btn btn-primary"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        {{ Form::model($registration, ['method' => 'PATCH','route' => ['admin.brand_registrations.update', $registration->id], 'class' => 'form-horizontal','id' => 'edit-page-form', 'files' => 'true']) }}



                                        <div class="form-group">
                                            <div class="col-sm-2">  Brand Name:</div>
                                            <div class="col-sm-8">  {{ $registration->brand_name }}</div></div>
                                        <div class="form-group">
                                            <div class="col-sm-2">  Website:</div>
                                            <div class="col-sm-8">  {{ $registration->website }}</div></div>
                                        <div class="form-group"><div class="col-sm-2">Category :</div>
                                            <div class="col-sm-8">  {{ $registration->category}}</div></div>
