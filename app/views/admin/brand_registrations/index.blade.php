...
@section('title','Idoag.com | Brand Registrations')
...
@section('content')
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <h1>
                    ...
                    <a href="{{ URL::route('admin_brand_registrations_export') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Export to Excel</a>
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    {{ Form::open(['route' => 'admin_brand_registrations_actions', 'class' => 'form-horizontal','id' => 'enquiries-actions-form']) }}
 ...
 <tr {{ ($registration->deleted_at!='') ? " class='deleted'" : "" }}>
                                                ...
                                                <td>{{ $registration->brand_name}}</td>
                                                <td>{{ $registration->name }}</td>
                                                <td>{{ $registration->email }}</td>
                                                <td>{{ $registration->status}}</td>
                                                <td>{{ date('Y-M-d H:i:s', strtotime($registration->created_at)) }}</td>

                                                <td><a href="{{ URL::route('admin.brand_registrations.edit', [$registration->id]) }}" class="btn btn-warning"><i class="fa fa-eye-open"></i> View</a></td>
