...
@section('title', 'Idoag.com | Add New Brand User')
      	...
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<ol class="breadcrumb">
            		...
            		<li class="active">Add New Brand User</li> -->
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        {{ Form::open(['route' => 'admin.brandsusers.store', 'class' => 'form-horizontal','id' => 'add-new-brand-user-form']) }}
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                            					...
                            					<div class="col-sm-8">
                                                	...
                                                	{{ Form::select('brand', $brands, '' , ['class' => 'form-control', 'id' => 'brand','required' => 'required']) }}
                                                    
                            						{{ errors_for('brand', $errors) }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-offset-3 col-sm-8">
                                                    ...
                                                    {{ Form::submit('Add New Brand User', ['class' => 'btn btn-lg btn-info btn-block']) }}
...
@section('js')
    ...
    <script type="text/javascript">
		...
		$(document).ready(function(e) {
			...
			/* Add New Brand User Form Validation Code Ends Here */
