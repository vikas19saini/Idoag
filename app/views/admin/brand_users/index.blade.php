...
@section('title','Idoag.com | Brands Users Dashboard')
...
@section('content')
      	...
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<h1>
                	...
                	List of Brands Users 
                    
                    <a href="{{ URL::route('admin.brandsusers.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Brand User</a>
                    
                     <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#brandsusers-import"><i class="fa fa-upload"></i> Import Excel</a>
                    
                    <a href="{{ URL::route('admin_brand_users_export') }}" class="btn btn-info"><i class="fa fa-download"></i> Export As Excel</a>

                    <a href="{{ URL::route('admin_brand_users_sample') }}" class="btn btn-info"><i class="fa fa-download"></i> Sample Excel</a>
          		...
          		<ol class="breadcrumb">
                    ...
                    <li class="active">Brands Users</li> -->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="box box-primary">
                    			...
                    			<div class="box-body">
                                    ...
                                    {{ Form::open(['route' => 'admin_brand_users_actions', 'class' => 'form-horizontal','id' => 'brand-users-actions-form']) }}
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($users as $key => $user)
                                                      ...
                                                      @if($user->deleted_at=='')
                                                        ...
                                                        <td><a href="{{ URL::route('admin.brandsusers.edit', [$user->id]) }}" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a></td>
    ...
    <div class="modal fade" id="brandsusers-import" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      	...
      	<div class="modal-dialog">
            ...
            <div class="modal-content">
          		...
          		<div class="modal-header">
            		...
            		<h4 class="modal-title">Import Brands Users</h4>
          
          		</div>
          
          		<div class="modal-body">
            
            		{{ Form::open(['route' => 'admin_brand_users_import', 'class' => 'form-horizontal','id' => 'brand_users-import-form', 'files' => true]) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-offset-2 col-sm-8">
                                ...
                                {{ Form::submit('Import Brands Users', ['class' => 'btn btn-lg btn-info btn-block']) }}
