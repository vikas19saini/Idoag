...
@section('title','Idoag.com | Admin Events Dashboard')
...
@section('content')
      	...
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<h1>
                    ...
                    <a href="{{ URL::route('admin.events.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Event</a>
                    
                    <!--  <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#brands-import"><i class="fa fa-upload"></i> Import Events</a>
                    
                    <a href="{{ URL::route('admin_brands_export') }}" class="btn btn-info"><i class="fa fa-download"></i> Export As Events</a> -->
            		...
            		<div class="col-lg-12">
                        ...
                        <div class="box box-primary">
                			...
                			<div class="box-body">
                                ...
                                {{ Form::open(['route' => 'admin_events_actions', 'class' => 'form-horizontal','id' => 'brands-actions-form']) }}
 ...
 <tr {{ ($event->deleted_at!='') ? " class='deleted'" : "" }}>
                                                    ...
                                                    <td>{{ getBrandName($event->brand_id) }}</td>
     ...
     <td><a href="{{ URL::route('admin.events.edit', [$event->id]) }}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a>
         <a href="{{ URL::route('event_details', [getBrandSlug($event->brand_id),$event->slug]) }}" target="_blank" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-list"></i></a></td>
