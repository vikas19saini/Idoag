...
@section('title','Idoag.com | Admin Links Dashboard')
      	...
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<h1>
                    ...
                    <a href="{{ URL::route('admin.links.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Link</a>
            		...
            		<div class="row"><div class="col-lg-12">
                        ...
                        <div class="box box-primary">
                			...
                			<div class="box-body">
                                ...
                                {{ Form::open(['route' => 'admin_links_actions', 'class' => 'form-horizontal','id' => 'links-actions-form']) }}
                                
                                    <table id="linkslist" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($links as $key => $link)
                                                ...
                                                <tr {{ ($link->deleted_at!='') ? " class='deleted'" : "" }}>
                                                    ...
                                                    <td>{{ getBrandName($link->brand_id) }}</td>
                                                    
                                                    <td>{{ ShortenText($link->description,200) }}</td>
                                                    
                                                    <td>{{ $link->status }}</td>
                                                                                                        
                                                    <td>{{ date('Y-M-d H:i:s', strtotime($link->created_at)) }}</td>

     <td><a href="{{ URL::route('admin.links.edit', [$link->id]) }}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a>
         <a href="{{ URL::route('link_details', [getBrandSlug($link->brand_id),$link->slug]) }}" target="_blank" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-list"></i></a></td>


                                                    <td><input name="checkall[]" type="checkbox" class="checkall" value="{{ $link->id }}"></td>
