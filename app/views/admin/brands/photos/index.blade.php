...
@section('title','Idoag.com | Admin Photos Dashboard')
      	...
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<h1>
                    ...
                    <a href="{{ URL::route('admin.photos.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Photo</a>
            		...
            		<div class="col-lg-12">
                        ...
                        <div class="box box-primary">
                			...
                			<div class="box-body">
                                ...
                                {{ Form::open(['route' => 'admin_photos_actions', 'class' => 'form-horizontal','id' => 'photos-actions-form']) }}
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($photos as $key => $photo)
                                                 ...
                                                 <tr {{ ($photo->deleted_at!='') ? " class='deleted'" : "" }}>
                                                    ...
                                                    <td>{{ getBrandName($photo->brand_id) }}</td>
                                                    ...
                                                    <td>{{ date('Y-m-d', strtotime($photo->created_at)) }}</td>
                                                      <td><a href="{{ URL::route('admin.photos.edit', [$photo->id]) }}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a>
                                                         <a href="{{ URL::route('photo_details', [getBrandSlug($photo->brand_id),$photo->slug]) }}" target="_blank" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-list"></i></a></td>
