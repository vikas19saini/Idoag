...
@section('title', 'Idoag.com | Edit User Profile')
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                       ...
                                       {{ Form::model($user, ['method' => 'PATCH', 'route' => ['admin.profiles.update', $user->id], 'class' => 'form-horizontal', 'id' => 'edit-user-form']) }}
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-offset-3 col-sm-8">
                                                    ...
                                                    {{ Form::submit('Update User', ['class' => 'btn btn-lg btn-info btn-block']) }}
...
@section('js')
    ...
    <script type="text/javascript">
		...
		$(document).ready(function(e) {
			...
			/* Edit User Form Validation Code Start Here */
			...
			/* Edit User Form Validation Code Ends Here */
