...
@section('title', 'Idoag.com | Add FAQ')
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        {{ Form::open(['route' => 'admin.faqs.store', 'class' => 'form-horizontal','id' => 'add-new-page-form', 'files' => 'true']) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-offset-3 col-sm-8">
                                                    ...
                                                    {{ Form::submit('Add FAQ', ['class' => 'btn btn-lg btn-info btn-block']) }}
