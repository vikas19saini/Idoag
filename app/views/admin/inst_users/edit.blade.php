...
@section('title', 'Idoag.com | Edit Institution User Profile')
        ...
        <!-- Content Block Starts Here -->
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<h1>Edit Institution User Profile</h1>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit Institution User Profile</li> -->
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                       ...
                                       {{ Form::model($user, ['method' => 'PATCH', 'route' => ['admin.institutions_users.update', $user->id], 'class' => 'form-horizontal', 'id' => 'edit-institution-user-form']) }}
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                            					...
                            					<div class="col-sm-8">
                                                	...
                                                	{{ Form::select('institution', $institutions, null , ['class' => 'form-control', 'id' => 'institution','required' => 'required']) }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-offset-3 col-sm-8">
                                                    ...
                                                    {{ Form::submit('Update Institution User', ['class' => 'btn btn-lg btn-info btn-block']) }}
