...
@section('title','Idoag.com | Institutions Users Dashboard')
...
@section('content')
      	...
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<h1>
                	...
                	List of Institution Users 
                    
                    <a href="{{ URL::route('admin.institutions_users.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Institution User</a>
                    
                     <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#institutionsusers-import"><i class="fa fa-upload"></i> Import Excel</a>
                    
                    <a href="{{ URL::route('admin_institution_users_export') }}" class="btn btn-info"><i class="fa fa-download"></i> Export As Excel</a>
                    
                    <a href="{{ URL::route('admin_inst_users_sample') }}" class="btn btn-info"><i class="fa fa-download"></i> Sample Excel</a>
          		...
          		<ol class="breadcrumb">
                    ...
                    <li class="active">Institution Users</li> -->
            		...
            		<div class="col-lg-12">
                        ...
                        <div class="box box-primary">
                			...
                			<div class="box-body">
                                ...
                                {{ Form::open(['route' => 'admin_institution_users_actions', 'class' => 'form-horizontal','id' => 'institution-users-actions-form']) }}
 ...
 <tr {{ ($user->deleted_at!='') ? " class='deleted'" : "" }}>
                                                    ...
                                                    <td><a href="{{ URL::route('admin.institutions_users.edit', [$user->id]) }}" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a></td>
 ...
 @endforeach                                    
    ...
    <div class="modal fade" id="institutionsusers-import" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      	...
      	<div class="modal-dialog">
            ...
            <div class="modal-content">
          		...
          		<div class="modal-header">
            		...
            		<h4 class="modal-title">Import Institution Users</h4>
          
          		</div>
          
          		<div class="modal-body">
            
            		{{ Form::open(['route' => 'admin_institution_users_import', 'class' => 'form-horizontal','id' => 'institution_users-import-form', 'files' => true]) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-offset-2 col-sm-8">
                                ...
                                {{ Form::submit('Import Institutions Users', ['class' => 'btn btn-lg btn-info btn-block']) }}
