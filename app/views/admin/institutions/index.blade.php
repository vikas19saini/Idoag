...
@section('content')
      	...
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<h1>
                    ...
                    <a href="{{ URL::route('admin.institutions.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Institution</a>
                    
                     <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#institutions-import"><i class="fa fa-upload"></i> Import Institutions</a>
                    
                    <a href="{{ URL::route('admin_institutions_export') }}" class="btn btn-info"><i class="fa fa-download"></i> Export As Excel</a>
            		...
            		<div class="col-lg-12">
                        ...
                        <div class="box box-primary">
                			...
                			<div class="box-body">
                                ...
                                {{ Form::open(['route' => 'admin_institutions_actions', 'class' => 'form-horizontal','id' => 'institutions-actions-form']) }}
                                
                                    <table id="institutionslist" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($institutions as $key => $data)
                                                 ...
                                                 <tr {{ ($data->deleted_at!='') ? " class='deleted'" : "" }}>
                                                    ...
                                                    <td><a href="{{ URL::route('admin.institutions.edit', [$data->id]) }}" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a></td>
                                                    <td><a href="template/{{$data->id}}" class="btn btn-warning"><i class="fa fa-pencil"></i> Template</a></td>

                                                    <td><input name="checkall[]" type="checkbox" class="checkall" value="{{ $data->id }}"></td>
 ...
 @endforeach                                    
    ...
    <!-- institutions Import Modal Starts Here-->
    <div class="modal fade" id="institutions-import" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      	...
      	<div class="modal-dialog">
            ...
            <div class="modal-content">
          		...
          		<div class="modal-header">
            		...
            		<h4 class="modal-title">Import Institutions</h4>
          
          		</div>
          
          		<div class="modal-body">
            
            		{{ Form::open(['route' => 'admin_institutions_import', 'class' => 'form-horizontal','id' => 'users-import-form', 'files' => true]) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-offset-2 col-sm-8">
                                ...
                                {{ Form::submit('Import Institutions', ['class' => 'btn btn-lg btn-info btn-block']) }}
    ...
    <!-- institutions Import Modal Ends Here-->
...
@section('js')
    ...
    <script type="text/javascript">
		...
		$(document).ready(function(e) {
			...
			var table = $('#institutionslist').DataTable( {
