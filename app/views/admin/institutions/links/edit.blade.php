      	...
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<ol class="breadcrumb">
                    ...
                    <a href="{{ URL::route('admin_inst_links') }}" class="btn btn-primary"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                       ...
                                       {{ Form::model($link, ['method' => 'PATCH','route' => ['admin.inst_links.update', $link->id], 'files' => true, 'class' => 'form-horizontal','id' => 'edit-link-form']) }}
