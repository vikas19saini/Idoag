...
@section('content')
      	...
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<h1>
                    ...
                    <a href="{{ URL::route('admin.inst_links.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Link</a>
            		...
            		<div class="row"><div class="col-lg-12">
                        ...
                        <div class="box box-primary">
                			...
                			<div class="box-body">
                                ...
                                {{ Form::open(['route' => 'admin_inst_links_actions', 'class' => 'form-horizontal','id' => 'links-actions-form']) }}
 ...
 <tr {{ ($link->deleted_at!='') ? " class='deleted'" : "" }}>
                                                    ...
                                                    <td>{{ getInstitutionName($link->institution_id) }}</td>
                                                    
                                                    <td>{{ ucfirst($link->description) }}</td>
                                                    ...
                                                    <td>{{ ($link->deleted_at != null) ? date('Y-M-d H:i:s', strtotime($link->deleted_at)) : '' }}</td>
                                                                                                    
                                                    <td><a href="{{ URL::route('admin.inst_links.edit', [$link->id]) }}" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a></td>
