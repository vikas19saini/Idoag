...
@section('title','Idoag.com | Internship Categories Dashboard')
      	...
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<h1>
                	...
                	List of Internship Categories 
                    
                    <a href="{{ URL::route('admin.internship_categories.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Category</a>
                    
                     <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#categories-import"><i class="fa fa-upload"></i> Import Categories</a>
                    
                    <a href="{{ URL::route('admin_internship_categories_export') }}" class="btn btn-info"><i class="fa fa-download"></i> Export As Excel</a>
            		...
            		<div class="col-lg-12">
                        ...
                        <div class="box box-primary">
                			...
                			<div class="box-body">
                                ...
                                {{ Form::open(['route' => 'admin_internship_categories_actions', 'class' => 'form-horizontal','id' => 'categories-actions-form']) }}
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($categories as $key => $category)
                                                 ...
                                                 <tr {{ ($category->deleted_at!='') ? " class='deleted'" : "" }}>
                                                    ...
                                                    <td><a href="{{ URL::route('admin.internship_categories.edit', [$category->id]) }}" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a></td>
      	...
      	<div class="modal-dialog">
            ...
            <div class="modal-content">
          		...
          		<div class="modal-body">
            		...
            		{{ Form::open(['route' => 'admin_internship_categories_import', 'class' => 'form-horizontal','id' => 'categories-import-form', 'files' => true]) }}
