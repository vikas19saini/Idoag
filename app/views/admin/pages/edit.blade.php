...
@section('title', 'Idoag.com | Edit Page')
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        {{ Form::model($page, ['method' => 'PATCH','route' => ['admin.pages.update', $page->id], 'class' => 'form-horizontal','id' => 'edit-page-form', 'files' => 'true']) }}
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-sm-offset-3 col-sm-8">
                                                    ...
                                                    {{ Form::submit('Update Page', ['class' => 'btn btn-lg btn-info btn-block']) }}
