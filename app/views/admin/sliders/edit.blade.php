...
@section('title', 'Idoag.com | Edit Slider')
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        {{ Form::model($slider, ['method' => 'PATCH','route' => ['admin.sliders.update', $slider->id], 'class' => 'form-horizontal','id' => 'edit-slider-form', 'files' => 'true']) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    @if($slider->image_name)
                                                    	...
                                                    	{{ HTML::image('uploads/'.$slider->image_name, '', ['id' => 'slider_image_preview', 'class' => 'slider-img']) }}
                                            ...
                                            <?php $mobileimg = 'm_'.$slider->image_name;?>
	 											...
	 											<div class="form-group">
	                                                ...
	                                                <div class="col-sm-5">
	                                                    ...
	                                                    @if($slider->image_name)
	                                                    	...
	                                                    	{{ HTML::image('uploads/m_'.$slider->image_name, '', ['id' => 'slider_image_mobile', 'class' => 'slider-img']) }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-offset-3 col-sm-8">
                                                    ...
                                                    {{ Form::submit('Update Slider', ['class' => 'btn btn-lg btn-info btn-block']) }}
...
@section('js')
    ...
    <script type="text/javascript">
		...
		$(document).ready(function(e) {
			...
			$('#edit-slider-form').formValidation({
					...
					page_name: {
						...
						validators: {
							...
							notEmpty: {
								...
								message: 'Choose at least one sldier type'
