...
@section('title','Idoag.com | Sliders Dashboard')
      	...
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<h1>
                    ...
                    <a href="{{ URL::route('admin.sliders.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Slider</a>
            		...
            		<div class="col-lg-12">
                        ...
                        <div class="box box-primary">
                			...
                			<div class="box-body">
                                ...
                                {{ Form::open(['route' => 'admin_sliders_actions', 'class' => 'form-horizontal','id' => 'sliders-actions-form']) }}
                                    ...
                                    <table id="sliderslist" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($sliders as $key => $slider)
                                                 ...
                                                 <tr {{ ($slider->deleted_at!='') ? " class='deleted'" : "" }}>
                                                    
                                                    <td>{{ $key+1 }}</td>
                                                    
                                                    <td>{{ ucfirst($slider->name) }}</td>
                                                    
                                                    <td>{{ ucfirst($slider->page_name) }}</td>
                                                    
                                                    <td>{{ ucfirst($slider->title) }}</td>
                                                    
                                                    @if($slider->image_name)
                                                    
                                                        <td>{{ HTML::image('uploads/'.$slider->image_name, '', ['class' => 'admin_thumbnail']) }}</td>
                                                    
                                                    @else
                                                        
                                                        <td>{{ HTML::image('assets/images/banner_img.jpg', '', ['class' => 'admin_thumbnail']) }}</td>
                                                    
                                                    @endif
                                                    <td>{{ $slider->status }}</td>
                                                    
                                                    <td>{{ date('Y-M-d H:i:s', strtotime($slider->created_at)) }}</td>
                                                                                                    
                                                    <td><a href="{{ URL::route('admin.sliders.edit', [$slider->id]) }}" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a></td>
                                                    
                                                    <td><input name="checkall[]" type="checkbox" class="checkall" value="{{ $slider->id }}"></td>
