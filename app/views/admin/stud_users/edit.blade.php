...
@section('title', 'Idoag.com | Edit Student User Profile')
        ...
        <!-- Content Block Starts Here -->
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<h1>Edit Student User Profile</h1>
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ URL::route('admin_institutions_users') }}"><i class="fa fa-group"></i> Students Users</a></li>

                    <li class="active">Edit Student User Profile</li> -->
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                       ...
                                       {{ Form::model($user, ['method' => 'PATCH', 'route' => ['admin.students_users.update', $user->id], 'class' => 'form-horizontal', 'id' => 'edit-student-user-form']) }}
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    {{ Form::text('dob', $studentdetails->dob, ['placeholder' => 'DOB', 'class' => 'form-control ']) }}
                                            ...
                                            <div class="form-group">
                            					...
                            					<div class="col-sm-8">
                                                	...
                                                	{{ Form::select('institution_id', $institutions, $studentdetails->institution_id , ['class' => 'form-control', 'id' => 'institution_id','required' => 'required']) }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-offset-3 col-sm-8">
                                                    ...
                                                    {{ Form::submit('Update Student User', ['class' => 'btn btn-lg btn-info btn-block']) }}
...
@section('js')
    ...
    <script type="text/javascript">
		...
		$(document).ready(function(e) {
			...
			/* Edit Institution User Form Validation Code Start Here */
			...
			/* Edit Institution User Form Validation Code Ends Here */
