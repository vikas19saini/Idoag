...
@section('title','Idoag.com | Student Registrations')
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <h1>
                    ...
                    <a href="{{ URL::route('admin_student_registrations_export') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Export to Excel</a>
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    {{ Form::open(['route' => 'admin_student_registrations_actions', 'class' => 'form-horizontal','id' => 'enquiries-actions-form']) }}
                                    ...
                                    <table id="registrationslist" class="table table-bordered table-hover">
                                        ...
                                        @foreach($registrations as $key => $registration)
                                              ...
                                              @if($registration->deleted_at=='')
                                                ...
                                                <td><a href="{{ URL::route('admin.student_registrations.edit', [$registration->id]) }}" class="btn btn-warning"><i class="fa fa-eye-open"></i> View</a></td>
