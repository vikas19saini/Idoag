...
@section('title', 'Idoag.com | Edit Student')
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                       ...
                                       {{ Form::model($student, ['method' => 'PATCH','route' => ['admin.students.update', $student->id], 'files' => true, 'class' => 'form-horizontal','id' => 'edit-student-form']) }}
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {{ Form::label('college_id', 'College Name', ['class' => 'col-sm-3 control-label']) }}

                                                <div class="col-sm-8">

													{{ Form::select('college_id', [null=>'Please Select'] + $institutions, null, array('class' => 'form-control')) }}
{{--
...
--}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-offset-3 col-sm-8">
                                                    ...
                                                    {{ Form::submit('Update Student', ['class' => 'btn btn-lg btn-info btn-block']) }}
...
@section('js')
    ...
    <script type="text/javascript">
		...
		$(document).ready(function(e) {
			...
			/* Edit Student Form Validation Code Start Here */

			$('#edit-student-form').formValidation({
			...
			/* Edit Student Form Validation Code Ends Here */
