...
@section('title','Idoag.com | Testimonials Dashboard')
      	...
      	<div class="content-wrapper">
        	...
        	<section class="content-header">
          		...
          		<h1>
                    ...
                    <a href="{{ URL::route('admin.testimonials.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Testimonial</a>
            		...
            		<div class="row"><div class="col-lg-12">
                        ...
                        <div class="box box-primary">
                			...
                			<div class="box-body">
                                ...
                                {{ Form::open(['route' => 'admin_testimonials_actions', 'class' => 'form-horizontal','id' => 'testimonials-actions-form']) }}
                                                 ...
                                                 <tr {{ ($testimonial->deleted_at!='') ? " class='deleted'" : "" }}>
                                                    ...
                                                    <td>{{ $key+1 }}</td>
                                                     <td>@if($testimonial->image!='')
                                                             {{ HTML::image('/uploads/testimonials/'.$testimonial->image, '', ['class' => 'admin_thumbnail']) }}
                                                     @endif
                                                     </td>
                                                    ...
                                                    <td><a href="{{ URL::route('admin.testimonials.edit', [$testimonial->id]) }}" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a></td>
