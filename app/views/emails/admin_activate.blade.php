...
<table  cellpadding="0" cellspacing="0" style="max-width:580px;  -webkit-border-radius: 2px; -moz-border-radius: 2px; border-radius: 2px; background-color: #fff; border: 1px solid #370c42; margin: 0 auto; padding:0px 10px; font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #838383; font-size: 14px">
    ...
    <tr>
        <td valign="top">
            ...
            <p style="color:#000; font-size:15px; line-height:24px;">An account has been created for you on <a href="www.idoag.com" style="color:#e8674e; text-decoration:underline;" target="_blank">www.idoag.com</a> </p>
                                        
            <!-- <p style="color:#000; font-size:15px; line-height:24px;"> Please click on this link <a href="{{ URL::to('new_password', array($token))}}" style="color:#e8674e; text-decoration:underline;" target="_blank">  http://idoag.dev/confirmation</a> </p> -->

            <p style="font-family: Arial, Helvetica, sans-serif; font-size:15px; color:#333; font-style:italic;">Please click on the Button below to confirm your account and set a password of your choice. </p>

            <p style="color:#000; font-size:15px; line-height:24px;"> Username : {{$email}}</p>
            ...
            <p style="color:#000; font-size:15px; line-height:24px;"> {{ URL::to('new_password', array($token))}} </p>
