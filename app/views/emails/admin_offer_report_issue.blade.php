...
<table  cellpadding="0" cellspacing="0" style="max-width:580px;  -webkit-border-radius: 2px; -moz-border-radius: 2px; border-radius: 2px; background-color: #fff; border: 1px solid #370c42; margin: 0 auto; padding:0px 10px; font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #838383; font-size: 14px">
    ...
    <tr>
        <td>
            <p style="font-family: Arial, Helvetica, sans-serif; font-size:15px; color:#333;"> User has reported problem with following: </p>

            <label> Brand              : </label>{{$brandname}}	           <br />
            <label> Offer              : </label>{{$offername}}	           <br />
            <label> Email		       : </label>{{$email}}	           <br />
            <label> Offer Link 	       : </label>{{$post_url}}	   <br />
            <label> Reported Issue     : </label>{{$reason}}       <br />
            <label> Comments           : </label>{{$problem_msg}}       <br />
            <label> Time Stamp         : </label>{{$date}}
        </td>
    </tr>
