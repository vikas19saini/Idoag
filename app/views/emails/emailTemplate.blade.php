...
<table cellpadding="0" cellspacing="0" style="width: 580px; max-width:580px; -webkit-border-radius: 2px; -moz-border-radius: 2px; border-radius: 2px; background-color: #fff; border: 1px solid #370c42; margin: 0 auto; padding:0px 10px; font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #838383;">
    <tr>
        <td>
			...
			<div style="background-image: url({{URL::route('home')}}/carddesign/{{$footer_design}}); background-repeat: no-repeat; width:500px; height:324px; color:#fff; padding-left: 25px;">
                <?php if($roll_no_required == 1 && $roll_no !== 'NULL'){?>
                    <div style="padding-top: 104px; font-size: 15px; float: right; color: #ffffff; margin-right: 40px;">{{$roll_no}}</div>
                <?php } ?>
