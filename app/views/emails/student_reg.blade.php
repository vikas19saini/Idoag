...
<table  cellpadding="0" cellspacing="0" style="max-width:580px;  -webkit-border-radius: 2px; -moz-border-radius: 2px; border-radius: 2px; background-color: #fff; border: 1px solid #370c42; margin: 0 auto; padding:0px 10px; font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #838383; font-size: 14px">
    ...
    <tr>
        <td>
            ...
            <p style="font-family: Arial, Helvetica, sans-serif; font-size:17px; color:#333;">Hi <span style="font-weight:bold; text-transform:uppercase; ">Admin,</span></p>
    ...
    <tr>
        <td>
        	<p style="font-family: Arial, Helvetica, sans-serif; font-size:15px; color:#333;"> Below are the details for the New Institution Register. </p>

        		<label> Institution          : </label>{{$inst_name}}	     <br />
        		<label> State 		         : </label>{{$state}}		     <br />
        		<label> City 		         : </label>{{$city}}		     <br />
        		<label> Student Name         : </label>{{$stud_name}}		 <br />
        		<label> Student Email 		 : </label>{{$stud_email}}		 <br />
        		<label> Student Mobile 		 : </label>{{$stud_mobile}}		 <br />
                <label> Contact Name         : </label>{{$name}}             <br />
                <label> Contact Designation  : </label>{{$designation}}      <br />
                <label> Contact Email        : </label>{{$email}}            <br />
                <label> Contact Mobile       : </label>{{$mobile}}           <br />                
        </td>
    </tr>
