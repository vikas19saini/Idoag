    ...
    <tr>
        <td valign="top">
            ...
            <ul>
                ...
                <li><p style="color:#000; font-size:15px; line-height:24px;"> Maintain Your Brand/Institute Page </p></li>
                                
                <li><p style="color:#000; font-size:15px; line-height:24px;"> Post Your Offers, Internships, Events, Text and Photos</p></li>
               
                <li><p style="color:#000; font-size:15px; line-height:24px;"> Add Your Outlets, View Followers and Feedback</p></li>
