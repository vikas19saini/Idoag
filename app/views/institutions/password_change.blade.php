            ...
            <div class="container_info">
                ...
                <div class="postanewoffer_info">
                    ...
                    <h3>{{HTML::Image('assets/images/note_img5.png')}} Password Change <a
                                href="{{ URL::route('institution_edit_profile', [$institution->slug]) }}"
                                class="btn btn-primary brand_password">Back</a></h3>

                    <?php //print_r($brand); ?>
                    {{Form::model($institution,['method' => 'POST','route' => ['InstPasswordChange', $institution->slug],'class'=>'form-horizontal' ,'id'=>'inst_password_change_form','files'=>true])}}
                    <ul>
                        <li>
...
@section('js')
    ...
    <script>
        ...
        $(function () {
            ...
            $('#inst_password_change_form').formValidation({
                framework: 'bootstrap',
                icon: {
