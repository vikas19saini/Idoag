...
@include('layouts.headerv2')
						...
						<div class="item wow fadeInUp">
							<div class="shadow-effect">
								<!--{{ HTML::image(getImage('uploads/photos/M_',$offer->image,'noimage.jpg'),'', array('class' => 'brand_img'))}}-->
                                                                <h1>{{ HTML::image(getImage('uploads/photos/',$offer->image,'noimage.jpg'),'',array('width' => 271, 'height' => 309))}}</h1>
								<!--<p>{{$offer->name}}</p>-->
								<button><a href="other-letest.html">Claim Now</a></button>
    ...
    <p>Get Your Refund 12 working hours Incase Of Transaction Failures.</p>
		...
		@endforeach  
          ...
          <div class="image-zm"><a href="#"><img src="images/brand/Ajio.png" alt=""></a></div>
           ...
           <div class="item"> 
          <div class="image-zm"><a href="#"><img src="images/brand/Dominos.png" alt=""></a></div>
            </div>
            <div class="item">
          <div class="image-zm"><a href="#"><img src="images/brand/ixigo.png" alt=""></a></div>
            </div>
            <div class="item">
          <div class="image-zm"><a href="#"><img src="images/brand/Jabong.png" alt=""></a></div>
            </div>
            <div class="item">
          <div class="image-zm"><a href="#"><img src="images/brand/kfc.png" alt=""></a></div>
            </div>
            <div class="item">
          <div class="image-zm"><a href="#"><img src="images/brand/Myntra.png" alt=""></a></div>
            </div>
            <div class="item">
          <div class="image-zm"><a href="#"><img src="images/brand/samsung.png" alt=""></a></div>
            </div>
            <div class="item">
          <div class="image-zm"><a href="#"><img src="images/brand/zoomcar.png" alt=""></a></div>
            </div>-->
        </div>
      </div>
    </section>
	...
	<!--<section class="partner_brand">
		...
		<div class="row">
			...
			@foreach($brands as $brand)
				<div class="item">
					<div class="image-zm"><a href="#">{{ HTML::image(getImage('uploads/brands/','a','noimage.jpg'))}}</a></div>
				</div>
			@endforeach
           <div class="item"> 
          <div class="image-zm"><a href="#"><img src="images/brand/Dominos.png" alt=""></a></div>
