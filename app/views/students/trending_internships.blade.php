...
@section('content')
  ...
  <h3>Trending Internships<a href="{{ URL::route('internships')}}" class="btn btn-primary mobile_back_btn"><i class="fa fa-angle-left"></i> Back</a></h3>
            <div class="notice_feed_list">
                <div class="notice_feed_listinner2">
                    <ul>
                        @foreach($trending_internships as $internship)
