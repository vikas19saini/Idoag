...
add_action( 'tgmpa_register', 'c5_arqam_register' );
/**
...
function c5_arqam_register() {
	...
	$plugins = array(
		array(
		    'name'               => 'Envato Tool Kit', // The plugin name.
		    'slug'               => 'envato-wordpress-toolkit-master', // The plugin slug (typically the folder name).
		    'source'             => 'http://files.code125.com/envato-wordpress-toolkit-master.zip', // The plugin source.
