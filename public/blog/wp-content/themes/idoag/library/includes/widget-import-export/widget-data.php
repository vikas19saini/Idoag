...
class Widget_Data {
	...
	public static function add_admin_menus() {
		// export
		$export_page = add_management_page( 'Widget Export', 'Widget Export', 'manage_options', 'widget-settings-export', array( __CLASS__, 'export_settings_page' ) );
		//import
		$import_page = add_management_page( 'Widget Import', 'Widget Import', 'manage_options', 'widget-settings-import', array( __CLASS__, 'import_settings_page' ) );
		...
		function widget_import_enqueue($hook){
			...
			wp_enqueue_style( 'widget_data',get_template_directory_uri().'/library/includes/widget-import-export/widget-data.css' );
			wp_enqueue_script( 'widget_data', get_template_directory_uri().'/library/includes/widget-import-export/widget-data.js', array( 'jquery', 'wp-ajax-response' ) );	
